        ...
        <div id={styles.insideBox}>
          ...
          <p id={styles.description}>
            <p>
              ...
              diárias. Convide outros usuários para participarem das suas viagens e receba
              informações atualizadas sobre o clima do seu destino. Tenha uma experiência de viagem
              organizada, conveniente e emocionante em um só lugar.
            </p>
          </p>
